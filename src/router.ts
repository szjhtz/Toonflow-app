// @routes-hash cd0c360844a1f493a1cf5deb6ab906b0
...
import route60 from "./routes/setting/agentDeploy/deployAgentModel";
import route61 from "./routes/setting/agentDeploy/getAgentDeploy";
import route62 from "./routes/setting/agentDeploy/updateKey";
import route63 from "./routes/setting/dbConfig/clearData";
import route64 from "./routes/setting/getTextModel";
import route65 from "./routes/setting/loginConfig/getUser";
import route66 from "./routes/setting/loginConfig/updateUserPwd";
import route67 from "./routes/setting/memoryConfig/getMemory";
import route68 from "./routes/setting/memoryConfig/sureMemory";
import route69 from "./routes/setting/vendorConfig/addVendor";
import route70 from "./routes/setting/vendorConfig/deleteVendor";
import route71 from "./routes/setting/vendorConfig/getVendorList";
import route72 from "./routes/setting/vendorConfig/modelTest";
import route73 from "./routes/setting/vendorConfig/updateVendor";
import route74 from "./routes/task/getTaskApi";
import route75 from "./routes/task/getTaskCategories";
import route76 from "./routes/task/taskDetails";
import route77 from "./routes/test/test";
...
export default async (app: Express) => {
  ...
  app.use("/api/setting/agentDeploy/deployAgentModel", route60);
  app.use("/api/setting/agentDeploy/getAgentDeploy", route61);
  app.use("/api/setting/agentDeploy/updateKey", route62);
  app.use("/api/setting/dbConfig/clearData", route63);
  app.use("/api/setting/getTextModel", route64);
  app.use("/api/setting/loginConfig/getUser", route65);
  app.use("/api/setting/loginConfig/updateUserPwd", route66);
  app.use("/api/setting/memoryConfig/getMemory", route67);
  app.use("/api/setting/memoryConfig/sureMemory", route68);
  app.use("/api/setting/vendorConfig/addVendor", route69);
  app.use("/api/setting/vendorConfig/deleteVendor", route70);
  app.use("/api/setting/vendorConfig/getVendorList", route71);
  app.use("/api/setting/vendorConfig/modelTest", route72);
  app.use("/api/setting/vendorConfig/updateVendor", route73);
  app.use("/api/task/getTaskApi", route74);
  app.use("/api/task/getTaskCategories", route75);
  app.use("/api/task/taskDetails", route76);
  app.use("/api/test/test", route77);
}
